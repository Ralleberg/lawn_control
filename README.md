...
Version `0.1.3` is advisory only. It exposes a robot mower permission entity,
...
The rule engine is intentionally simple in `0.1.3`. It uses transparent scoring and blocking checks for:
