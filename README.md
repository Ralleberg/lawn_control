...
Version `0.1.0` is advisory only. It exposes a robot mower permission entity,
...
The rule engine is intentionally simple in `0.1.0`. It uses transparent scoring and blocking checks for:
